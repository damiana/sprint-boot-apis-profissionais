...
public class ComentarioController {
    ...
    @DeleteMapping("/{id}")
    @Operation(summary = "Remove um comentário. Permitido apenas à pessoa autora do comentário ou do treino.")
    public ResponseEntity<Void> remover(@PathVariable Long treinoId, @PathVariable Long id) {
        comentarioService.remover(treinoId, id);
